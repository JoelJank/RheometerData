...
│             └── lowstress_dried
├── Scripts/                    
│    ├── Analysis                #Python File to create Mohr-Coulomb-Diagramm
│    ├── Excel_Manipulation      #Python File to manipulate large Excel files
└── visualization                # Python Files used to create plots (file directories in Python files wrong!!!)
